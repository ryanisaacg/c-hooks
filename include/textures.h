...
void texture_draw_ex(Texture texture, SDL_Renderer *rend, Rect destination, double angle, bool fip_x, bool flip_y, Uint8 alpha);
...
void animation_draw_ex(Animation anim, SDL_Renderer *rend, Rect destination, double angle, bool fip_x, bool flip_y, Uint8 alpha);
